#
#  Be sure to run `pod spec lint Animal.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Oscar Lemus"
  # s.authors            = { "Oscar Lemus" => "oscar.lemus@ozmovil.com" }
  # s.social_media_url   = "http://twitter.com/Oscar Lemus"
